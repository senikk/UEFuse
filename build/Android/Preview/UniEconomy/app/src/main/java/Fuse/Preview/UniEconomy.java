...
public class UniEconomy extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    {
    	UniEconomy activity = _appState.CurrentActivity;
