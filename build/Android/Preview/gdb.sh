#!/bin/sh
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.31.1/Targets/Android/gdb.sh.
...
PID=`adb shell ps | awk -f $NDK_DIR/build/awk/extract-pid.awk -v PACKAGE="Fuse.Preview"`
DATA_DIR=/data/data/Fuse.Preview #`adb shell run-as Fuse.Preview /system/bin/sh -c pwd`
DEVICE_GDBSERVER=$DATA_DIR/lib/gdbserver

echo ""
echo "## Starting gdbserver at $DEVICE_GDBSERVER"
adb shell run-as Fuse.Preview $DEVICE_GDBSERVER +debug-socket --attach $PID &
