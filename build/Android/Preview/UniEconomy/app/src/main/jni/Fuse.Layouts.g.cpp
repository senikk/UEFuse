...
// /usr/local/share/uno/Packages/Fuse.Controls.Panels/0.31.5/Layouts/$.uno
// -----------------------------------------------------------------------
...
static void DefinitionBase_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Panels/0.31.5/Layouts/$.uno");
...
// public enum FlowDirection :2290
...
// public GridLayout() :1428
void GridLayout__ctor_2_fn(GridLayout* __this)
{
    __this->ctor_2();
}

// internal override sealed void ArrangePaddingBox(Uno.Collections.IList<Fuse.Node> elements, float4 padding, Fuse.LayoutParams lp) :1713
...
// private void ColumnRemoved(Fuse.Layouts.Column c) :1465
...
// public Fuse.Elements.Alignment get_ContentAlignment() :1217
void GridLayout__get_ContentAlignment_fn(GridLayout* __this, int* __retval)
{
    *__retval = __this->ContentAlignment();
}

// public void set_ContentAlignment(Fuse.Elements.Alignment value) :1218
...
// public static int GetColumnSpan(Fuse.Visual elm) :1408
void GridLayout__GetColumnSpan_fn(::g::Fuse::Visual* elm, int* __retval)
{
    *__retval = GridLayout::GetColumnSpan(elm);
}

// internal override sealed float2 GetContentSize(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) :1473
...
// private float2 Measure(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) :1486
...
// private void RowRemoved(Fuse.Layouts.Row r) :1449
...
// public GridLayout() [instance] :1428
...
// public float get_CellSpacing() [instance] :1203
...
// public void set_CellSpacing(float value) [instance] :1204
...
// private void Changed() [instance] :1434
...
// private void ColumnAdded(Fuse.Layouts.Column c) [instance] :1457
...
uString* GridLayout::ColumnData()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1138);
    return Columns();
}
...
void GridLayout::ColumnData(uString* value)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1143);
    Columns(value);
}
...
// private void ColumnRemoved(Fuse.Layouts.Column c) [instance] :1465
...
// public Fuse.Elements.Alignment get_ContentAlignment() [instance] :1217
...
// public void set_ContentAlignment(Fuse.Elements.Alignment value) [instance] :1218
...
// private float get_EffectiveCellSpacing() [instance] :1480
...
// private Fuse.Elements.Alignment get_EffectiveContentAlignment() [instance] :1699
...
// private int GetActualColumn(Fuse.Visual elm) [instance] :1388
...
// private void GetActualPositions(Uno.Collections.IList<Fuse.Node> elements) [instance] :1294
...
// private int GetActualRow(Fuse.Visual elm) [instance] :1248
...
// private Fuse.Layouts.Column GetColumns(int column) [instance] :1186
...
// private Fuse.Layouts.Row GetRows(int row) [instance] :1193
...
// private float2 Measure(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) [instance] :1486
...
// private void RowAdded(Fuse.Layouts.Row r) [instance] :1441
...
uString* GridLayout::RowData()
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1068);
    return Rows();
}
...
void GridLayout::RowData(uString* value)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[7/*"GridLayout:...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1073);
    Rows(value);
}
...
// private void RowRemoved(Fuse.Layouts.Row r) [instance] :1449
...
// public static int GetColumn(Fuse.Visual elm) [static] :1287
...
// public static int GetColumnSpan(Fuse.Visual elm) [static] :1408
...
// public static int GetRow(Fuse.Visual elm) [static] :1241
...
// public static int GetRowSpan(Fuse.Visual elm) [static] :1268
...
// public GridLayout New() [static] :1428
...
// public static void ResetColumn(Fuse.Visual elm) [static] :1396
...
// public static void ResetColumnSpan(Fuse.Visual elm) [static] :1419
...
// public static void ResetRow(Fuse.Visual elm) [static] :1256
...
// public static void ResetRowSpan(Fuse.Visual elm) [static] :1275
...
// public static void SetColumn(Fuse.Visual elm, int col) [static] :1281
...
// public static void SetColumnSpan(Fuse.Visual elm, int span) [static] :1402
...
// public static void SetRow(Fuse.Visual elm, int row) [static] :1235
...
// public static void SetRowSpan(Fuse.Visual elm, int span) [static] :1262
...
// public abstract class Layout :1818
// {
// static Layout() :1818
...
// internal Layout() :1823
void Layout__ctor_1_fn(Layout* __this)
{
    __this->ctor_1();
}

// internal static void AdjustAlignBox(Fuse.Visual node, float2 sz, float4 box, Fuse.Elements.Alignment align) :1994
...
// protected bool AffectsLayout(Fuse.Node n) :1870
void Layout__AffectsLayout_fn(Layout* __this, ::g::Fuse::Node* n, bool* __retval)
{
    *__retval = __this->AffectsLayout(n);
}

// protected bool ArrangeMarginBoxSpecial(Fuse.Node n, float4 padding, Fuse.LayoutParams lp) :1882
...
// public static bool GetFillPadding(Fuse.Visual n) :1835
void Layout__GetFillPadding_fn(::g::Fuse::Visual* n, bool* __retval)
{
    *__retval = Layout::GetFillPadding(n);
}

// private static Fuse.Controls.LayoutControl GetLayoutControl(Fuse.Visual elm) :1967
...
// protected bool AffectsLayout(Fuse.Node n) [instance] :1870
...
// protected bool ArrangeMarginBoxSpecial(Fuse.Node n, float4 padding, Fuse.LayoutParams lp) [instance] :1882
...
// protected void InvalidateLayout() [instance] :1929
...
// internal void RemoveContainer(Fuse.Controls.LayoutControl element) [instance] :1860
...
// internal void SetContainer(Fuse.Controls.LayoutControl element) [instance] :1853
...
// protected float Snap(float p) [instance] :1962
...
// protected float2 Snap(float2 p) [instance] :1955
...
// protected bool get_SnapToPixels() [instance] :1937
...
// protected float SnapUp(float p) [instance] :1950
...
// protected float2 SnapUp(float2 p) [instance] :1943
...
// internal static void AdjustAlignBox(Fuse.Visual node, float2 sz, float4 box, Fuse.Elements.Alignment align) [static] :1994
...
// public static bool GetFillPadding(Fuse.Visual n) [static] :1835
...
// private static Fuse.Controls.LayoutControl GetLayoutControl(Fuse.Visual elm) [static] :1967
...
// protected static void InvalidateAncestorLayout(Fuse.Visual child) [static] :1916
...
// private static void InvalidateLayout(Fuse.Visual elm) [static] :1979
...
// public static void ResetFillPadding(Fuse.Visual n) [static] :1845
...
// public static void SetFillPadding(Fuse.Visual n, bool f) [static] :1828
...
// private static float SimpleOff(float sz, float2 range, Fuse.Elements.SimpleAlignment align) [static] :2007
...
// public static class Layouts :2018
// {
// static Layouts() :2018
...
// public sealed class StackLayout :2051
// {
...
// public generated StackLayout() :2051
void StackLayout__ctor_2_fn(StackLayout* __this)
{
    __this->ctor_2();
}

// internal override sealed void ArrangePaddingBox(Uno.Collections.IList<Fuse.Node> elements, float4 padding, Fuse.LayoutParams lp) :2215
...
// public Fuse.Elements.Alignment get_ContentAlignment() :2093
void StackLayout__get_ContentAlignment_fn(StackLayout* __this, int* __retval)
{
    *__retval = __this->ContentAlignment();
}

// public void set_ContentAlignment(Fuse.Elements.Alignment value) :2094
void StackLayout__set_ContentAlignment_fn(StackLayout* __this, int* value)
{
    __this->ContentAlignment(*value);
}

// private Fuse.Elements.SimpleAlignment get_EffectiveContentAlignment() :2202
void StackLayout__get_EffectiveContentAlignment_fn(StackLayout* __this, int* __retval)
{
    *__retval = __this->EffectiveContentAlignment();
}

// private float get_EffectiveItemSpacing() :2158
void StackLayout__get_EffectiveItemSpacing_fn(StackLayout* __this, float* __retval)
{
    *__retval = __this->EffectiveItemSpacing();
}

// internal override sealed float2 GetContentSize(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) :2119
...
// public Fuse.Elements.Alignment get_ContentAlignment() [instance] :2093
...
// public void set_ContentAlignment(Fuse.Elements.Alignment value) [instance] :2094
...
// private Fuse.Elements.SimpleAlignment get_EffectiveContentAlignment() [instance] :2202
...
// private float get_EffectiveItemSpacing() [instance] :2158
...
// private float2 GetElementsSize(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) [instance] :2165
...
// public float get_ItemSpacing() [instance] :2079
...
// public void set_ItemSpacing(float value) [instance] :2080
...
// public Fuse.Layouts.StackLayoutMode get_Mode() [instance] :2107
...
// public void set_Mode(Fuse.Layouts.StackLayoutMode value) [instance] :2108
...
// public Fuse.Layouts.Orientation get_Orientation() [instance] :2058
...
// public void set_Orientation(Fuse.Layouts.Orientation value) [instance] :2059
...
// public void ResetOrientation() [instance] :2069
...
// public generated StackLayout New() [static] :2051
...
// public enum StackLayoutMode :2045
...
// public sealed class WrapLayout :2295
// {
...
// public generated WrapLayout() :2295
void WrapLayout__ctor_2_fn(WrapLayout* __this)
{
    __this->ctor_2();
}

// internal override sealed void ArrangePaddingBox(Uno.Collections.IList<Fuse.Node> elements, float4 padding, Fuse.LayoutParams lp) :2412
...
// public Fuse.Layouts.FlowDirection get_FlowDirection() :2337
void WrapLayout__get_FlowDirection_fn(WrapLayout* __this, int* __retval)
{
    *__retval = __this->FlowDirection();
}

// public void set_FlowDirection(Fuse.Layouts.FlowDirection value) :2338
void WrapLayout__set_FlowDirection_fn(WrapLayout* __this, int* value)
{
    __this->FlowDirection(*value);
}

// internal override sealed float2 GetContentSize(Uno.Collections.IList<Fuse.Node> elements, Fuse.LayoutParams lp) :2347
...
// public Fuse.Layouts.FlowDirection get_FlowDirection() [instance] :2337
...
// public void set_FlowDirection(Fuse.Layouts.FlowDirection value) [instance] :2338
...
// public generated string get_ID() [instance] :2345
...
// public generated void set_ID(string value) [instance] :2345
...
// public float get_ItemHeight() [instance] :2301
...
// public void set_ItemHeight(float value) [instance] :2302
...
// public float get_ItemWidth() [instance] :2313
...
// public void set_ItemWidth(float value) [instance] :2314
...
// public Fuse.Layouts.Orientation get_Orientation() [instance] :2325
...
// public void set_Orientation(Fuse.Layouts.Orientation value) [instance] :2326
...
// public generated WrapLayout New() [static] :2295
