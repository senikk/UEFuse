...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("Fuse/Preview/UniEconomy");
    jclass entryPointsClass = env->FindClass("Fuse/Preview/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("Fuse/Preview/Display");
