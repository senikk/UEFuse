...
// /usr/local/share/uno/Packages/Fuse.Scripting/0.31.5/$.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.31.5/Scripting/$.uno
// -------------------------------------------------------------
...
// public sealed class CodeModule :333
// {
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :335
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :335
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [instance] :335
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [static] :335
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[4/*"new Array("*/], uBox<int>(::TYPES[24/*int*/], uPtr(values)->Length())), ::STRINGS[5/*")"*/])), ::TYPES[5/*Fuse.Scripting.Array*/]);
...
void Context::ObjectDefineProperty(::g::Fuse::Scripting::Object* obj, uString* name, uDelegate* getProperty, uDelegate* setProperty, bool enumerable, bool configurable)
{
    ...
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[25/*bool*/], enumerable), uBox(::TYPES[25/*bool*/], configurable)));
}
...
void Context::ObjectDefineProperty1(::g::Fuse::Scripting::Object* obj, uString* name, uObject* value, bool enumerable, bool configurable)
{
    ...
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 5, obj, name, value, uBox(::TYPES[25/*bool*/], enumerable), uBox(::TYPES[25/*bool*/], configurable)));
}
...
// private sealed class JSCallback.FuncClosure<TArg, TArg1, TResult> :1152
// {
...
// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) :1156
void JSCallback__FuncClosure2__ctor__fn(JSCallback__FuncClosure2* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) :1156
...
// public object Run(object[] args) :1161
void JSCallback__FuncClosure2__Run_fn(JSCallback__FuncClosure2* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->Run(args);
}

// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) [instance] :1156
...
// public object Run(object[] args) [instance] :1161
...
// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) [static] :1156
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) :1052
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) [static] :1052
...
// public static class JSObjectUtils :1264
// {
static void JSObjectUtils_build(uType* type)
{
    ::STRINGS[3] = uString::Const("(no file)");
    ::STRINGS[15] = uString::Const("Object.freeze");
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::Marshal_typeof();
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("ValueOrDefault`1", type, (void*)JSObjectUtils__ValueOrDefault1_fn, 0, true, type->U(0), 2, uObject_typeof()->Array(), ::g::Uno::Int_typeof()),
        new uFunction("ValueOrDefault`1", type, (void*)JSObjectUtils__ValueOrDefault2_fn, 0, true, type->U(0), 3, uObject_typeof()->Array(), ::g::Uno::Int_typeof(), type->U(0)));
}
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) :1284
void JSObjectUtils__Freeze_fn(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    JSObjectUtils::Freeze(ob, c);
}

// public static T ValueOrDefault<T>(Fuse.Scripting.Object obj, string name, T defaultValue) :1266
void JSObjectUtils__ValueOrDefault_fn(uType* __type, ::g::Fuse::Scripting::Object* obj, uString* name, void* defaultValue, uTRef __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[19/*Fuse.Scripting.Marshal*/]->MakeMethod(1, __type->U(0)),
    };
    uStackFrame __("Fuse.Scripting.JSObjectUtils", "ValueOrDefault`1(Fuse.Scripting.Object,string,T)");
    uT ret1(__types[0], U_ALLOCA(__types[0]->ValueSize));

    if (uPtr(obj)->Item(name) == NULL)
        return __retval.Store(__types[0], defaultValue), void();

    return __retval.Store((::g::Fuse::Scripting::Marshal__ToType_fn(__types[1], uPtr(obj)->Item(name), &ret1), ret1)), void();
}

// public static T ValueOrDefault<T>(object[] args, int index) :1272
void JSObjectUtils__ValueOrDefault1_fn(uType* __type, uArray* args, int* index, uTRef __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[19/*Fuse.Scripting.Marshal*/]->MakeMethod(1, __type->U(0)),
    };
    uStackFrame __("Fuse.Scripting.JSObjectUtils", "ValueOrDefault`1(object[],int)");
    uT ret2(__types[0], U_ALLOCA(__types[0]->ValueSize));
    int index_ = *index;
...
// public static T ValueOrDefault<T>(object[] args, int index, T defaultValue) :1278
void JSObjectUtils__ValueOrDefault2_fn(uType* __type, uArray* args, int* index, void* defaultValue, uTRef __retval)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[19/*Fuse.Scripting.Marshal*/]->MakeMethod(1, __type->U(0)),
    ...
    return __retval.Store((::g::Fuse::Scripting::Marshal__ToType_fn(__types[1], uPtr(args)->Strong<uObject*>(index_), &ret3), ret3)), void();
}

// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) [static] :1284
void JSObjectUtils::Freeze(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    ...
    ::g::Fuse::Scripting::Function* freeze = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(::STRINGS[3/*"(no file)"*/], ::STRINGS[15/*"Object.freeze"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[25] = uString::Const("null");
    ::STRINGS[26] = uString::Const("true");
    ::STRINGS[27] = uString::Const("false");
    ::STRINGS[28] = uString::Const("\"");
    ::TYPES[20] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof());
    ...
    ::TYPES[28] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[29] = ::g::Uno::Comparison_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[5] = ::g::Fuse::Scripting::Array_typeof();
...
uString* Json::Stringify(uObject* value, bool normalized)
{
    ...
    ::g::Uno::Text::StringBuilder* sb = ::g::Uno::Text::StringBuilder::New1();
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[20/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    if (uIs(value, ::TYPES[21/*string*/]))
        Json::ToLiteral3(uCast<uString*>(value, ::TYPES[21/*string*/]), sb);
    else if (uIs(value, ::TYPES[22/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[22/*double*/], value)));
    else if (uIs(value, ::TYPES[23/*float*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<float>(::TYPES[23/*float*/], value)));
    else if (uIs(value, ::TYPES[24/*int*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<int>(::TYPES[24/*int*/], value)));
    else if (uIs(value, ::TYPES[25/*bool*/]))
        uPtr(sb)->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[25/*bool*/], value)));
    else if (uIs(value, ::TYPES[6/*Fuse.Scripting.Object*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[18/*"Json.String...*/]));
        ...
        uArray* keys = uArray::New(::TYPES[26/*string[]*/], uPtr(uPtr(obj)->Keys())->Length());
        ::g::Uno::Array::Copy1(::TYPES[27/*Uno.Array.Copy<string>*/], obj->Keys(), keys, uPtr(obj->Keys())->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[28/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[29/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
    ...
    else if (uIs(value, ::TYPES[5/*Fuse.Scripting.Array*/]))
    {
        ...
        sb->Append2(::STRINGS[24/*"]"*/]);
    }
    else
        uPtr(sb)->Append2(::STRINGS[25/*"null"*/]);
}
...
uString* Json::ToLiteral(bool b)
{
    ...
    if (b)
        return ::STRINGS[26/*"true"*/];
    else
        return ::STRINGS[27/*"false"*/];
}
...
uString* Json::ToLiteral1(double s)
{
    ...
    if ((double)(int)s == s)
        return ::g::Uno::Int::ToString((int)s, ::TYPES[24/*int*/]);

    return ::g::Uno::Double::ToString(s, ::TYPES[22/*double*/]);
}
...
uString* Json::ToLiteral2(uString* s)
{
    ...
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[28/*"\""*/], Json::Escape(s)), ::STRINGS[28/*"\""*/]);
}
...
{
    Marshal::_convertibleClasses_ = uArray::Init<uType*>(::TYPES[30/*Uno.Type[]*/], 2, ::TYPES[31/*Fuse.Drawing.Brush*/], ::TYPES[35/*Uno.UX.FileSource*/]);
}

static void Marshal_build(uType* type)
{
    ::STRINGS[29] = uString::Const("Unable to convert ");
    ::STRINGS[30] = uString::Const(" to bool");
    ::STRINGS[31] = uString::Const("Expected number was ");
    ::STRINGS[32] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.31.5/$.uno");
    ::STRINGS[33] = uString::Const("path");
    ::STRINGS[34] = uString::Const(" to a FileSource");
    ::STRINGS[35] = uString::Const("#");
    ::STRINGS[36] = uString::Const(" to float4");
    ::STRINGS[37] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[38] = uString::Const("%");
    ::STRINGS[39] = uString::Const("px");
    ::STRINGS[40] = uString::Const("pt");
    ::STRINGS[41] = uString::Const("Unable to parse size value: ");
    ::STRINGS[42] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[43] = uString::Const("Unable to convert '");
    ::STRINGS[44] = uString::Const("' to type ");
    ::TYPES[30] = ::g::Uno::Type_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Type_typeof();
    ::TYPES[25] = ::g::Uno::Bool_typeof();
    ::TYPES[21] = ::g::Uno::String_typeof();
    ...
    ::TYPES[24] = ::g::Uno::Int_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[32] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[33] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[34] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
...
// public static float4 ToFloat4(Fuse.Scripting.Array values) :490
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret5), ret5))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[43/*"Unable to c...*/], o), ::STRINGS[44/*"' to type "*/]), __types[0])));
}
...
bool Marshal::ToBool(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[25/*bool*/]))
        return uUnbox<bool>(::TYPES[25/*bool*/], obj);
    else if (uIs(obj, ::TYPES[21/*string*/]))
        return ::g::Uno::Bool::Parse(uCast<uString*>(obj, ::TYPES[21/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[29/*"Unable to c...*/], obj), ::STRINGS[30/*" to bool"*/])));
}
...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[31/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[32/*"/usr/local/...*/], 392);
        return 0.0;
    }
}
...
::g::Uno::UX::FileSource* Marshal::ToFileSource(uObject* obj)
{
    ...
    {
        uString* path = uCast<uString*>(obj, ::TYPES[21/*string*/]);
        ...
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[34/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), path))
                return ::g::Uno::UX::BundleFileSource::New1(f);
        }

        return ::g::Fuse::Scripting::JSFileSource::New1(uCast<uString*>(obj, ::TYPES[21/*string*/]));
    }
    else if (uIs(obj, ::TYPES[6/*Fuse.Scripting.Object*/]))
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(uPtr(uCast< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[6/*Fuse.Scripting.Object*/]))->Item(::STRINGS[33/*"path"*/]), ::TYPES[21/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[29/*"Unable to c...*/], ::g::Uno::Object::GetType(uPtr(obj))), ::STRINGS[34/*" to a FileS...*/])));
}
...
// public static float4 ToFloat4(Fuse.Scripting.Array values) [static] :490
...
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[21/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[35/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[29/*"Unable to c...*/], o), ::STRINGS[36/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[36/*Uno.UX.Selector*/]))
        ...
        return ::g::Uno::UX::Selector__op_Implicit(uCast<uString*>(o, ::TYPES[21/*string*/]));

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[37/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[42/*"Unable to p...*/], o)));
}
...
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
        return NULL;
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[25/*bool*/]))
        return uBox(::TYPES[25/*bool*/], Marshal::ToBool(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[23/*float*/]))
        return uBox(::TYPES[23/*float*/], Marshal::ToFloat(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[22/*double*/]))
        return uBox(::TYPES[22/*double*/], Marshal::ToDouble(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[24/*int*/]))
        return uBox<int>(::TYPES[24/*int*/], Marshal::ToInt(o));
        ...
        return ::g::Uno::Enum::Parse(t, uCast<uString*>(o, ::TYPES[21/*string*/]));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[31/*Fuse.Drawing.Brush*/]))
        return Marshal::ToBrush(o);
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[35/*Uno.UX.FileSource*/]))
...
{
    ::STRINGS[45] = uString::Const("exports");
    ::STRINGS[46] = uString::Const("id");
    ::TYPES[1] = uObject_typeof();
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[45/*"exports"*/], c->NewObject());
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[46/*"id"*/], id);
...
uObject* Module::EvaluateExports(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[45/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[47] = uString::Const("(unknown module)");
    ::STRINGS[45] = uString::Const("exports");
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[47/*"(unknown mo...*/], void();
}
...
uObject* ModuleResult::Exports()
{
    ...
    return uPtr(Object)->Item(::STRINGS[45/*"exports"*/]);
}
...
{
    ::STRINGS[48] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[45] = uString::Const("exports");
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[45/*"exports"*/]), ::TYPES[6/*Fuse.Scripting.Object*/]);
...
// public generated NativeModule New() :613
...
void NativeModule::AddMember(::g::Fuse::Scripting::NativeMember* member)
{
    ...
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[48/*"NativeModul...*/]));
...
// public generated NativeModule New() [static] :613
...
// public NativeProperty New(string name) :967
...
// public NativeProperty New(string name) [static] :967
...
uObject* JSCallback__NumberConverter::Convert(double value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[24/*int*/]))
        return uBox<int>(::TYPES[24/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[60/*long*/]))
        return uBox<int64_t>(::TYPES[60/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[23/*float*/]))
        return uBox(::TYPES[23/*float*/], (float)value);

    return uBox(::TYPES[22/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[22/*double*/]))
        return uBox(::TYPES[22/*double*/], (double)value);

    return uBox(::TYPES[23/*float*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[24/*int*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[24/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[24/*int*/], value), targetType);

    if (uIs(value, ::TYPES[60/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[60/*long*/], value), targetType);

    if (uIs(value, ::TYPES[23/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[23/*float*/], value), targetType);

    if (uIs(value, ::TYPES[22/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[22/*double*/], value), targetType);
...
{
    ::STRINGS[49] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[50] = uString::Const(" provided");
    ::STRINGS[51] = uString::Const("require(): argument must be a string");
    ::STRINGS[52] = uString::Const("require(): module not found: ");
    ::STRINGS[53] = uString::Const("JavaScript error in ");
    ::STRINGS[54] = uString::Const(" was fixed!");
    ::STRINGS[32] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.31.5/$.uno");
    ::STRINGS[55] = uString::Const("Require");
    ::STRINGS[56] = uString::Const(" line ");
...
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[49/*"require(): ...*/], uBox<int>(::TYPES[24/*int*/], uPtr(args)->Length())), ::STRINGS[50/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[21/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[51/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[52/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[53/*"JavaScript ...*/], path), ::STRINGS[54/*" was fixed!"*/]), this, ::STRINGS[32/*"/usr/local/...*/], 204, ::STRINGS[55/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[53/*"JavaScript ...*/], path), ::STRINGS[56/*" line "*/]), uBox<int>(::TYPES[24/*int*/], uPtr(e)->LineNumber())), ::STRINGS[57/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[32/*"/usr/local/...*/], 214, ::STRINGS[55/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[45/*"exports"*/]);
}
...
// public static new Fuse.Scripting.ScriptEventArgs get_Empty() :37
...
// public static new Fuse.Scripting.ScriptEventArgs get_Empty() [static] :37
...
{
    ::STRINGS[58] = uString::Const("Name: ");
    ::STRINGS[59] = uString::Const("Error message: ");
    ::STRINGS[60] = uString::Const("File name: ");
    ::STRINGS[61] = uString::Const("Line number: ");
    ::STRINGS[62] = uString::Const("Source line: ");
    ::STRINGS[63] = uString::Const("JS stack trace: ");
    ::TYPES[24] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
{
    ::STRINGS[64] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[65] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.31.5/Scripting/$.uno");
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[64/*"Cannot call...*/], __this, ::STRINGS[65/*"/usr/local/...*/], 129, ::STRINGS[66/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[67/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[67] = uString::Const("require(): module contains an error: ");
    ::STRINGS[68] = uString::Const(".");
    ::STRINGS[69] = uString::Const("/");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[70] = uString::Const("..");
    ::STRINGS[71] = uString::Const("(function(");
    ...
    ::STRINGS[45] = uString::Const("exports");
    ::STRINGS[76] = uString::Const("module, exports, require");
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[71/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[72/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[73/*"\n })"*/]);
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[45/*"exports"*/]));
    ...
    return *__retval = ::STRINGS[76/*"module, exp...*/], void();
}
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    ...
    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[68/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[69/*"/"*/]))
    {
        *isFile = true;
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[32/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[33/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[34/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[32/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[33/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[34/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[8/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[68/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[70/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[69/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
double Value::ToNumber(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[22/*double*/]))
        return uUnbox<double>(::TYPES[22/*double*/], obj);

    if (uIs(obj, ::TYPES[23/*float*/]))
        return (double)uUnbox<float>(::TYPES[23/*float*/], obj);

    if (uIs(obj, ::TYPES[24/*int*/]))
        return (double)uUnbox<int>(::TYPES[24/*int*/], obj);
