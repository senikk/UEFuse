...
public final class Activity
{
    ...
    {
        return Fuse.Preview.UniEconomy.GetRootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends Fuse.Preview.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        Fuse.Preview.UniEconomy activity = (Fuse.Preview.UniEconomy)getRootActivity();
