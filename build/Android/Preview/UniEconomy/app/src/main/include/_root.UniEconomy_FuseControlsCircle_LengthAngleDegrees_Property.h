...
namespace g{struct UniEconomy_FuseControlsCircle_LengthAngleDegrees_Property;}
...
struct UniEconomy_FuseControlsCircle_LengthAngleDegrees_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Circle*> _obj;

    void ctor_2(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name);
    static UniEconomy_FuseControlsCircle_LengthAngleDegrees_Property* New1(::g::Fuse::Controls::Circle* obj, ::g::Uno::UX::Selector name);
};
// }
