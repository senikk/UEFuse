...
// /usr/local/share/uno/Packages/Uno.Net.Sockets/0.31.1/$.uno
// ----------------------------------------------------------
...
bool Dns::JavaGetLocalAddresses(::g::Uno::Collections::List* addresses)
{
    uStackFrame __("Uno.Net.Dns", "JavaGetLocalAddresses(Uno.Collections.List<string>)");
    {
        ...
        jobject _addresses = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box5(addresses);
        jboolean __jresult = _jni->CallStaticBooleanMethod(__cls, __mtd,_addresses);
        bool __result = (bool)__jresult;
        if (_addresses!=NULL) { _jni->DeleteLocalRef(_addresses); }
