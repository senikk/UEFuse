...
namespace g{struct UniEconomy_FuseControlsPanel_Opacity_Property;}
...
struct UniEconomy_FuseControlsPanel_Opacity_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Panel*> _obj;

    void ctor_2(::g::Fuse::Controls::Panel* obj, ::g::Uno::UX::Selector name);
    static UniEconomy_FuseControlsPanel_Opacity_Property* New1(::g::Fuse::Controls::Panel* obj, ::g::Uno::UX::Selector name);
};
// }
