// This file was generated based on /Users/terjepedersen/Prosjekt/Fuse/UniEconomy/build/Android/Preview/preamble/$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("10.0.0.118");
    ::STRINGS[2] = uString::Const("/Users/terjepedersen/Prosjekt/Fuse/UniEconomy/UniEconomy.unoproj");
    ::STRINGS[3] = uString::Const("UniEconomy");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"UniEconomy"*/]);
}
