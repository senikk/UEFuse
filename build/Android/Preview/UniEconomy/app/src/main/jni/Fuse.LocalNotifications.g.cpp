...
// /usr/local/share/uno/Packages/Fuse.LocalNotifications/0.31.5/Android/$.uno
// --------------------------------------------------------------------------
...
// public static void Later(string title, string body, bool sound, string strPayload, [int delaySeconds]) :102
...
// private static void NotificationRecieved(string payload) :87
void AndroidImpl__NotificationRecieved_fn(uString* payload)
{
    AndroidImpl::NotificationRecieved(payload);
}

// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) :49
void AndroidImpl__OnEnteringInteractive_fn(int* newState)
{
    AndroidImpl::OnEnteringInteractive(*newState);
}

// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) :54
...
void AndroidImpl::Init()
{
    ...
    if (!AndroidImpl::_init())
    {
        ...
        ::g::Uno::Platform2::Application::add_EnteringInteractive(uDelegate::New(::TYPES[0/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)AndroidImpl__OnEnteringInteractive_fn));
        ::g::Uno::Platform2::Application::add_ExitedInteractive(uDelegate::New(::TYPES[0/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)AndroidImpl__OnExitedInteractive_fn));
    }
}
...
// public static void Later(string title, string body, bool sound, string strPayload, [int delaySeconds]) [static] :102
void AndroidImpl::Later(uString* title, uString* body, bool sound, uString* strPayload, int delaySeconds)
{
    ...
    AndroidImpl_typeof()->Init();
    {
        JniHelper _jni;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Later202", "(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V");
        jstring _title = JniHelper::UnoToJavaString(title);
        jstring _body = JniHelper::UnoToJavaString(body);
        jstring _strPayload = JniHelper::UnoToJavaString(strPayload);
        _jni->CallStaticVoidMethod(__cls, __mtd,_title,_body,(jboolean)sound,_strPayload,(jint)delaySeconds);
        
        if (_title!=NULL) { _jni->DeleteLocalRef(_title); }
        if (_body!=NULL) { _jni->DeleteLocalRef(_body); }
        if (_strPayload!=NULL) { _jni->DeleteLocalRef(_strPayload); }
        ::g::Android::Base::JNI::CheckException();
...
// private static int NextID() [static] :96
...
void AndroidImpl::NoteInteractivity(bool isItInteractive)
{
    ...
    AndroidImpl_typeof()->Init();
    {
        ...
        _jni->CallStaticVoidMethod(__cls, __mtd,(jboolean)isItInteractive);
...
// private static void NotificationRecieved(string payload) [static] :87
...
// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) [static] :49
void AndroidImpl::OnEnteringInteractive(int newState)
{
    uStackFrame __("Fuse.LocalNotifications.AndroidImpl", "OnEnteringInteractive(Uno.Platform2.ApplicationState)");
    AndroidImpl_typeof()->Init();
    AndroidImpl::NoteInteractivity(true);
}

// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) [static] :54
void AndroidImpl::OnExitedInteractive(int newState)
{
    uStackFrame __("Fuse.LocalNotifications.AndroidImpl", "OnExitedInteractive(Uno.Platform2.ApplicationState)");
    AndroidImpl_typeof()->Init();
    AndroidImpl::NoteInteractivity(false);
}
// }

// /usr/local/share/uno/Packages/Fuse.LocalNotifications/0.31.5/$.uno
// ------------------------------------------------------------------
...
// public object ClearAllNotifications(Fuse.Scripting.Context context, object[] args) :231
...
// public object ClearBadgeNumber(Fuse.Scripting.Context context, object[] args) :225
...
// private static int GetInt(object arg, string argName) :212
void LocalNotify__GetInt_fn(uObject* arg, uString* argName, int* __retval)
{
    *__retval = LocalNotify::GetInt(arg, argName);
}

// public object Later(Fuse.Scripting.Context context, object[] args) :174
...
// public object Now(Fuse.Scripting.Context context, object[] args) :196
...
// private static void OnReceived(object sender, string message) :166
...
void LocalNotify::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[3/*"now"*/], uDelegate::New(::TYPES[4/*Fuse.Scripting.NativeCallback*/], (void*)LocalNotify__Now_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[4/*"later"*/], uDelegate::New(::TYPES[4/*Fuse.Scripting.NativeCallback*/], (void*)LocalNotify__Later_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[5/*"clearBadgeN...*/], uDelegate::New(::TYPES[4/*Fuse.Scripting.NativeCallback*/], (void*)LocalNotify__ClearBadgeNumber_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[6/*"clearAllNot...*/], uDelegate::New(::TYPES[4/*Fuse.Scripting.NativeCallback*/], (void*)LocalNotify__ClearAllNotifications_fn, this)));
    AddMember(LocalNotify::_onReceivedMessage());

    if (!LocalNotify::_registered())
    {
        ::g::Fuse::LocalNotifications::Notify::add_Received(uDelegate::New(::TYPES[5/*Uno.EventHandler<string>*/], (void*)LocalNotify__OnReceived_fn));
        LocalNotify::_registered() = true;
    }
}

// public object ClearAllNotifications(Fuse.Scripting.Context context, object[] args) [instance] :231
...
// public object ClearBadgeNumber(Fuse.Scripting.Context context, object[] args) [instance] :225
...
// public object Later(Fuse.Scripting.Context context, object[] args) [instance] :174
uObject* LocalNotify::Later(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        ::g::Fuse::LocalNotifications::Notify::Later(secondsFromNow, uCast<uString*>(args->Strong<uObject*>(1), ::TYPES[8/*string*/]), uCast<uString*>(args->Strong<uObject*>(2), ::TYPES[8/*string*/]), (args->Strong<uObject*>(3) != NULL) ? uCast<uString*>(args->Strong<uObject*>(3), ::TYPES[8/*string*/]) : ::STRINGS[11/*""*/], hasSoundArg ? uUnbox<bool>(::TYPES[9/*bool*/], args->Strong<uObject*>(4)) : true, badgeNumber);
    }

    return NULL;
}

// public object Now(Fuse.Scripting.Context context, object[] args) [instance] :196
uObject* LocalNotify::Now(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
    {
        ...
        ::g::Fuse::LocalNotifications::Notify::Now(uCast<uString*>(args->Strong<uObject*>(0), ::TYPES[8/*string*/]), uCast<uString*>(args->Strong<uObject*>(1), ::TYPES[8/*string*/]), (args->Strong<uObject*>(2) == NULL) ? ::STRINGS[11/*""*/] : uCast<uString*>(args->Strong<uObject*>(2), ::TYPES[8/*string*/]), hasSoundArg ? uUnbox<bool>(::TYPES[9/*bool*/], args->Strong<uObject*>(3)) : true, badgeNumber);
    }

    return NULL;
}

// private static int GetInt(object arg, string argName) [static] :212
int LocalNotify::GetInt(uObject* arg, uString* argName)
{
    ...
    if (uIs(arg, ::TYPES[6/*int*/]))
        return uUnbox<int>(::TYPES[6/*int*/], arg);
    else if (uIs(arg, ::TYPES[7/*double*/]))
        return (int)uUnbox<double>(::TYPES[7/*double*/], arg);
    else
...
// private static void OnReceived(object sender, string message) [static] :166
void LocalNotify::OnReceived(uObject* sender, uString* message)
{
    ...
    LocalNotify_typeof()->Init();
    uPtr(LocalNotify::_onReceivedMessage())->RaiseAsync(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, message));
}
// }
...
static void Notify_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[12] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
void Notify::ClearAllNotifications()
{
    ...
    Notify_typeof()->Init();
    {
        JniHelper _jni;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearAllNotifications204", "()V");
        _jni->CallStaticVoidMethod(__cls, __mtd);
...
void Notify::add__receivedNotification(uDelegate* value)
{
    ...
    Notify_typeof()->Init();
    Notify::_receivedNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Notify::_receivedNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Notify::remove__receivedNotification(uDelegate* value)
{
    ...
    Notify_typeof()->Init();
    Notify::_receivedNotification1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Notify::_receivedNotification1(), value), ::TYPES[5/*Uno.EventHandler<string>*/]);
}
...
void Notify::add_Received(uDelegate* value)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<uString*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(Notify::_pendingNotifications()), &ret2), ret2); enum1.MoveNext(::TYPES[12/*Uno.Collections.List<string>.Enumerator*/]); )
    {
        uString* n = enum1.Current(::TYPES[12/*Uno.Collections.List<string>.Enumerator*/]);
