...
// /usr/local/share/uno/Packages/Android/0.31.1/Android/android/net/http/$.uno
// ---------------------------------------------------------------------------

// public sealed extern class SslError :611
// {
static void SslError_build(uType* type)
{
...
// public static extern new void _Init() :615
void SslError___Init2_fn()
{
    SslError::_Init2();
}

// public override sealed Android.java.lang.String toString() :833
void SslError__toString_fn(SslError* __this, ::g::Android::java::lang::String** __retval)
{
    uStackFrame __("Android.android.net.http.SslError", "toString()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_10162(bool arg0, Android.Base.Primitives.ujobject arg1) :859
...
// public static extern new void _Init() [static] :615
void SslError::_Init2()
{
    uStackFrame __("Android.android.net.http.SslError", "_Init()");
...
// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_10162(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :859
uObject* SslError::toString_IMPL_10162(bool arg0_, jobject arg1_)
{
    uStackFrame __("Android.android.net.http.SslError", "toString_IMPL_10162(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
