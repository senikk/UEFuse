...
#include <_root.OutracksSimulatorClientUno_OutracksSimulatorErrorToast_Fi-c0827a7b.h>
...
#include <_root.OutracksSimulatorClientUno_OutracksSimulatorErrorToast_St-d7b784b0.h>
...
// private void DoNothing() :208
void Application__DoNothing_fn(Application* __this)
{
    __this->DoNothing();
}

// private void InvalidateSelection(object sender, Uno.EventArgs args) :145
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) :210
void Application__OnPointerMoved_fn(Application* __this, ::g::Fuse::Input::PointerMovedArgs* args)
{
    __this->OnPointerMoved(args);
}

// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) :178
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) :217
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) :231
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) :241
...
// protected override sealed void OnUpdate() :247
...
// private void DoNothing() [instance] :208
void Application::DoNothing()
{
}

// private void InvalidateSelection(object sender, Uno.EventArgs args) [instance] :145
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) [instance] :210
...
// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) [instance] :178
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) [instance] :217
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) [instance] :231
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) [instance] :241
...
// private void ResetEverything() [instance] :150
...
// private void SetState(Outracks.Simulator.State nextState) [instance] :261
...
// private void ShowDeveloperMenu() [instance] :191
...
// private void TryUnrootEverything() [instance] :162
void Application::TryUnrootEverything()
{
    ...
    try
    {
        ...
        ::g::Fuse::AppBase__OnUpdate_fn(this);
    }
...
// public sealed class ArrayStream :1127
// {
...
// public override sealed bool get_CanSeek() :1146
...
// public override sealed bool get_CanTimeout() :1151
...
// public override sealed bool get_CanWrite() :1141
...
// public ArrayStream New(byte[] buffer) :1172
void ArrayStream__New1_fn(uArray* buffer, ArrayStream** __retval)
{
    *__retval = ArrayStream::New1(buffer);
}

// public generated override sealed long get_Position() :1170
...
// public generated override sealed void set_Position(long value) :1170
...
// public override sealed int Read(byte[] dst, int byteOffset, int byteCount) :1192
...
// private void ResizeTo(int newSize) :1236
void ArrayStream__ResizeTo_fn(ArrayStream* __this, int* newSize)
{
    __this->ResizeTo(*newSize);
}

// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :1203
...
// public override sealed void SetLength(long value) :1249
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :1178
...
// public ArrayStream(byte[] buffer) [instance] :1172
...
// public int get_Capacity() [instance] :1164
...
// private void EnsureCapacity(int byteCount) [instance] :1220
...
// public byte[] GetBuffer() [instance] :1244
...
// private void ResizeTo(int newSize) [instance] :1236
...
// public ArrayStream New(byte[] buffer) [static] :1172
...
// public static class Bundle :2233
// {
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) :2236
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) [static] :2236
...
// public static class BytecodeCache :1622
// {
static void BytecodeCache_build(uType* type)
{
    ::STRINGS[9] = uString::Const("The impossible has happened");
    ::STRINGS[10] = uString::Const(".");
    ::STRINGS[11] = uString::Const("/");
    ::STRINGS[12] = uString::Const("Fusetools");
    ::STRINGS[13] = uString::Const("Fuse");
    ::STRINGS[14] = uString::Const("Cache");
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) :1625
void BytecodeCache__TrySave_fn(::g::Outracks::Simulator::Protocol::Reify* reify)
{
    BytecodeCache::TrySave(reify);
}

// private static Outracks.Simulator.Protocol.Reify Load() [static] :1661
::g::Outracks::Simulator::Protocol::Reify* BytecodeCache::Load()
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[9/*"The impossi...*/]));
}

// private static void Save(Outracks.Simulator.Protocol.Reify reify) [static] :1637
...
// public static Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify> TryLoad() [static] :1649
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) [static] :1625
...
// private static string get_CacheFileName() [static] :1683
uString* BytecodeCache::CacheFileName()
{
    uStackFrame __("Outracks.Simulator.BytecodeCache", "get_CacheFileName()");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition(uBox<uint32_t>(::g::Uno::UInt_typeof(), BytecodeCache::ProjectHash()), ::STRINGS[10/*"."*/]), ::g::Outracks::Simulator::Protocol::Reify::BinaryFormat());
}

// private static string get_CachePath() [static] :1673
uString* BytecodeCache::CachePath()
{
    uStackFrame __("Outracks.Simulator.BytecodeCache", "get_CachePath()");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(BytecodeCache::FuseDataDirectory(), ::STRINGS[11/*"/"*/]), BytecodeCache::CacheFileName());
}

// private static string get_FuseDataDirectory() [static] :1678
uString* BytecodeCache::FuseDataDirectory()
{
    uStackFrame __("Outracks.Simulator.BytecodeCache", "get_FuseDataDirectory()");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::IO::Directory::GetUserDirectory(1), ::STRINGS[11/*"/"*/]), ::STRINGS[12/*"Fusetools"*/]), ::STRINGS[11/*"/"*/]), ::STRINGS[13/*"Fuse"*/]), ::STRINGS[11/*"/"*/]), ::STRINGS[14/*"Cache"*/]);
}

// private static uint get_ProjectHash() [static] :1688
...
// internal sealed class ChangeIp :740
// {
static void ChangeIp_build(uType* type)
{
    ::STRINGS[15] = uString::Const("Connect to IP");
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :761
...
// protected override sealed Outracks.Simulator.State OnOk(string input) :747
...
// public ChangeIp([string body]) [instance] :742
void ChangeIp::ctor_2(uString* body)
{
    uStackFrame __("Outracks.Simulator.ChangeIp", ".ctor([string])");
    ctor_1(::STRINGS[15/*"Connect to IP"*/], ::g::Uno::String::op_Addition2(body, ::STRINGS[16/*"\nE.g. '192...*/]));
}

// public ChangeIp New([string body]) [static] :742
...
// private sealed class EnumerableHitTestExtension.CollectHitNodesClosure :2122
// {
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) :2126
...
// public void HitTestCallback(Fuse.HitTestResult result) :2131
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) :2126
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) [instance] :2126
...
// public void HitTestCallback(Fuse.HitTestResult result) [instance] :2131
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) [static] :2126
...
// internal abstract class Connected :426
// {
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) :430
void Connected__ctor_1_fn(Connected* __this, uObject* client)
{
    __this->ctor_1(client);
}

// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) :480
...
// public override Outracks.Simulator.State OnEnterState() :436
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :442
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) :474
...
// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) :469
...
// public override Outracks.Simulator.State OnUpdate() :452
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) [instance] :430
...
// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) [instance] :480
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) [instance] :474
...
// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) [instance] :469
...
// internal abstract class Connecting :338
// {
...
// protected generated Connecting() :338
void Connecting__ctor_1_fn(Connecting* __this)
{
    __this->ctor_1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :340
...
// protected generated Connecting() [instance] :338
...
// internal sealed class ConnectingToHost :385
// {
static void ConnectingToHost_build(uType* type)
{
    ::STRINGS[17] = uString::Const("Connecting");
    ::STRINGS[18] = uString::Const("Fetching project data from computer");
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :389
void ConnectingToHost__ctor_2_fn(ConnectingToHost* __this, uObject* simulatorEndpoints)
{
    __this->ctor_2(simulatorEndpoints);
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :389
...
// public override sealed Outracks.Simulator.State OnEnterState() :396
void ConnectingToHost__OnEnterState_fn(ConnectingToHost* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[17/*"Connecting"*/], ::STRINGS[18/*"Fetching pr...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :411
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [instance] :389
...
// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :389
...
// internal sealed class ConnectingToProxy :347
// {
static void ConnectingToProxy_build(uType* type)
{
    ::STRINGS[17] = uString::Const("Connecting");
    ::STRINGS[19] = uString::Const("Connecting to computer...");
    ::TYPES[45] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[46] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
...
// public override sealed Outracks.Simulator.State OnEnterState() :362
void ConnectingToProxy__OnEnterState_fn(ConnectingToProxy* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[17/*"Connecting"*/], ::STRINGS[19/*"Connecting ...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :376
...
// public ConnectingToProxy() [instance] :357
...
// public ConnectingToProxy(Uno.Net.IPEndPoint[] proxyEndpoints) [instance] :352
...
// public ConnectingToProxy New() [static] :357
...
// public ConnectingToProxy New(Uno.Net.IPEndPoint[] proxyEndpoints) [static] :352
...
// internal sealed class ConnectionLost :710
// {
static void ConnectionLost_build(uType* type)
{
    ::STRINGS[20] = uString::Const("Connection lost");
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[21] = uString::Const("Change IP");
    ::STRINGS[22] = uString::Const("Reconnect");
...
// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) :716
...
// public ConnectionLost(Uno.Exception exception) :712
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) :716
...
// public ConnectionLost New(Uno.Exception exception) :712
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance] :716
void ConnectionLost::ctor_2(::g::Outracks::Simulator::Protocol::ExceptionInfo* exception)
{
    ...
    ctor_1(::STRINGS[20/*"Connection ...*/], uPtr(exception)->Message, ::STRINGS[0/*""*/], ::g::Outracks::Simulator::GoOffline::PrependOption(uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[49/*Outracks.Simulator.DialogButton[]*/], 2, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[21/*"Change IP"*/], ::g::Outracks::Simulator::ChangeIp::New1(::STRINGS[0/*""*/])), (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[22/*"Reconnect"*/], ::g::Outracks::Simulator::ConnectingToProxy::New1()))));
}

// public ConnectionLost(Uno.Exception exception) [instance] :712
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static] :716
...
// public ConnectionLost New(Uno.Exception exception) [static] :712
...
// internal sealed class ConnectToEndpointClosure :968
// {
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) :972
...
// public Uno.Net.Sockets.Socket Execute() :977
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) :972
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) [instance] :972
...
// public Uno.Net.Sockets.Socket Execute() [instance] :977
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) [static] :972
...
// public static class ConnectToFirstRespondingEndpoint :951
// {
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :953
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) :962
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :953
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) [static] :962
...
// public static class Context :1804
// {
static void Context_build(uType* type)
{
    ::STRINGS[23] = uString::Const("N/A");
    ::STRINGS[24] = uString::Const("DESIGN MODE");
    ::STRINGS[25] = uString::Const("PREVIEW MODE");
...
// public static generated Outracks.Simulator.FakeApp get_App() :1807
void Context__get_App_fn(::g::Outracks::Simulator::FakeApp** __retval)
{
    *__retval = Context::App();
}

// private static generated void set_App(Outracks.Simulator.FakeApp value) :1807
void Context__set_App_fn(::g::Outracks::Simulator::FakeApp* value)
{
    Context::App(value);
}

// public static generated string[] get_Defines() :1810
void Context__get_Defines_fn(uArray** __retval)
{
    *__retval = Context::Defines();
}

// private static generated void set_Defines(string[] value) :1810
void Context__set_Defines_fn(uArray* value)
{
    Context::Defines(value);
}

// public static generated Outracks.Simulator.InputMode get_InputMode() :1806
void Context__get_InputMode_fn(int* __retval)
{
    *__retval = Context::InputMode();
}

// private static generated void set_InputMode(Outracks.Simulator.InputMode value) :1806
void Context__set_InputMode_fn(int* value)
{
    Context::InputMode(*value);
}

// public static generated string get_Project() :1809
void Context__get_Project_fn(uString** __retval)
{
    *__retval = Context::Project();
}

// private static generated void set_Project(string value) :1809
void Context__set_Project_fn(uString* value)
{
    Context::Project(value);
}

// public static Uno.IO.Bundle get_ProjectBundle() :1815
void Context__get_ProjectBundle_fn(::g::Uno::IO::Bundle** __retval)
{
    *__retval = Context::ProjectBundle();
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() :1808
void Context__get_ProxyEndpoints_fn(uArray** __retval)
{
    *__retval = Context::ProxyEndpoints();
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) :1808
void Context__set_ProxyEndpoints_fn(uArray* value)
{
    Context::ProxyEndpoints(value);
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() :1818
void Context__get_Reflection_fn(uObject** __retval)
{
    *__retval = Context::Reflection();
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) :1818
void Context__set_Reflection_fn(uObject* value)
{
    Context::Reflection(value);
}

// public static void SetApp(Outracks.Simulator.FakeApp app) :1836
void Context__SetApp_fn(::g::Outracks::Simulator::FakeApp* app)
{
    Context::SetApp(app);
}

// public static void SetDesignMode() :1820
void Context__SetDesignMode_fn()
{
    Context::SetDesignMode();
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) :1841
...
// public static void SetInteractiveMode() :1828
...
// public static void SetApp(Outracks.Simulator.FakeApp app) [static] :1836
...
// public static void SetDesignMode() [static] :1820
void Context::SetDesignMode()
{
    ...
    Context::InputMode(1);
    ::g::Fuse::Preview::SelectionManager::SetSelection((uObject*)::g::Outracks::Simulator::Runtime::Selection::New1(::STRINGS[23/*"N/A"*/], NULL));
    uPtr(Context::App())->Flash(::STRINGS[24/*"DESIGN MODE"*/]);
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) [static] :1841
...
// public static void SetInteractiveMode() [static] :1828
void Context::SetInteractiveMode()
{
    ...
    Context::InputMode(0);
    ::g::Fuse::Preview::SelectionManager::SetSelection((uObject*)::g::Outracks::Simulator::Runtime::Selection::New1(::STRINGS[23/*"N/A"*/], NULL));
    uPtr(Context::App())->Flash(::STRINGS[25/*"PREVIEW MODE"*/]);
}

// public static generated Outracks.Simulator.FakeApp get_App() [static] :1807
...
// private static generated void set_App(Outracks.Simulator.FakeApp value) [static] :1807
...
// public static generated string[] get_Defines() [static] :1810
...
// private static generated void set_Defines(string[] value) [static] :1810
...
// public static generated Outracks.Simulator.InputMode get_InputMode() [static] :1806
...
// private static generated void set_InputMode(Outracks.Simulator.InputMode value) [static] :1806
...
// public static generated string get_Project() [static] :1809
...
// private static generated void set_Project(string value) [static] :1809
...
// public static Uno.IO.Bundle get_ProjectBundle() [static] :1815
...
// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() [static] :1808
...
// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) [static] :1808
...
// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() [static] :1818
...
// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [static] :1818
...
// public partial sealed class DeveloperMenu :2286
// {
// static DeveloperMenu() :182
static void DeveloperMenu__cctor_4_fn(uType* __type)
{
    DeveloperMenu::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[26/*"Opacity"*/]);
}
...
static void DeveloperMenu_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("Fuse Preview Menu");
    ::STRINGS[29] = uString::Const("Tap to dismiss");
    ::TYPES[12] = ::g::Fuse::Visual_typeof();
...
// private void Close(object sender, Uno.EventArgs args) :2293
void DeveloperMenu__Close_fn(DeveloperMenu* __this, uObject* sender, ::g::Uno::EventArgs* args)
{
    __this->Close(sender, args);
}

// private void GoBack(object sender, Uno.EventArgs args) :2288
...
// private void Close(object sender, Uno.EventArgs args) [instance] :2293
...
// private void GoBack(object sender, Uno.EventArgs args) [instance] :2288
...
void DeveloperMenu::InitializeUX()
{
    ...
    temp3->Value(::STRINGS[28/*"Fuse Previe...*/]);
    temp3->Color(::g::Fuse::Drawing::Colors::White());
    temp3->Alignment(10);
    temp4->Value(::STRINGS[29/*"Tap to dism...*/]);
...
// public static extern class DeviceInfo :1728
// {
...
// public static string get_Name() [static] :1732
...
// internal sealed class DialogButton :1592
// {
...
// public DialogButton(string text, Outracks.Simulator.State destination) :1597
...
// public DialogButton New(string text, Outracks.Simulator.State destination) :1597
...
// public DialogButton(string text, Outracks.Simulator.State destination) [instance] :1597
...
// public DialogButton New(string text, Outracks.Simulator.State destination) [static] :1597
...
// internal static class EnumerableHitTestExtension :2112
// {
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) :2114
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) [static] :2114
...
// public partial sealed class ErrorToast :2262
// {
// static ErrorToast() :77
static void ErrorToast__cctor_5_fn(uType* __type)
{
    ErrorToast::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[30/*"Value"*/]);
    ErrorToast::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[31/*"Message"*/]);
    ErrorToast::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[32/*"ShowMonitor...*/]);
    ErrorToast::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[26/*"Opacity"*/]);
    ErrorToast::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[33/*"Color"*/]);
    ErrorToast::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[34/*"FillColor"*/]);
    ErrorToast::__selector6_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[35/*"StrokeColor"*/]);
}

static void ErrorToast_build(uType* type)
{
    ::STRINGS[30] = uString::Const("Value");
    ::STRINGS[31] = uString::Const("Message");
    ::STRINGS[32] = uString::Const("ShowMonitorInfo");
    ::STRINGS[26] = uString::Const("Opacity");
    ::STRINGS[33] = uString::Const("Color");
    ::STRINGS[34] = uString::Const("FillColor");
    ::STRINGS[35] = uString::Const("StrokeColor");
    ::STRINGS[36] = uString::Const("See Fuse Monitor (Cmd/Ctrl+M) for details");
    ::STRINGS[37] = uString::Const("Got it");
    ...
    ::TYPES[63] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[64] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[76] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[77] = ::g::Uno::Delegate_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
...
// public generated void add_Dismissed(Uno.Action value) :2276
void ErrorToast__add_Dismissed_fn(ErrorToast* __this, uDelegate* value)
{
    __this->add_Dismissed(value);
}

// public generated void remove_Dismissed(Uno.Action value) :2276
...
// public generated void add_Dismissed(Uno.Action value) [instance] :2276
...
// public generated void remove_Dismissed(Uno.Action value) [instance] :2276
...
void ErrorToast::InitializeUX1()
{
    ...
    ::g::Fuse::Controls::PropertyBinding* temp5 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[71/*Fuse.Controls.PropertyBinding<string>*/], temp_Value_inst, this_Message_inst);
    ::g::Fuse::Controls::Text* temp6 = ::g::Fuse::Controls::Text::New3();
    ::g::Fuse::Controls::Button* temp7 = ::g::Fuse::Controls::Button::New5();
    ::g::Fuse::Controls::PropertyBinding* temp8 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[72/*Fuse.Controls.PropertyBinding<bool>*/], temp1_Value_inst, this_ShowMonitorInfo_inst);
    ::g::Fuse::Triggers::AddingAnimation* temp9 = ::g::Fuse::Triggers::AddingAnimation::New2();
    ::g::Fuse::Animations::Scale* temp10 = ::g::Fuse::Animations::Scale::New2();
    ::g::Fuse::Animations::Change* temp11 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[61/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ...
    ::g::Fuse::Animations::Change* temp14 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[61/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ::g::Fuse::Controls::PropertyBinding* temp15 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[73/*Fuse.Controls.PropertyBinding<float4>*/], temp2_Color_inst, this_FillColor_inst);
    ::g::Fuse::Controls::PropertyBinding* temp16 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[73/*Fuse.Controls.PropertyBinding<float4>*/], temp3_Color_inst, this_StrokeColor_inst);
    temp4->Width(::g::Uno::UX::Size__New1(75.0f, 4));
    temp4->Alignment(14);
    temp4->Margin(::g::Uno::Float4__New2(40.0f, 40.0f, 40.0f, 40.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp9);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp12);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    temp->TextWrapping(1);
    temp->FontSize(16.0f);
    temp->TextAlignment(1);
    temp->TextColor(::g::Fuse::Drawing::Colors::White());
    temp->Margin(::g::Uno::Float4__New2(20.0f, 20.0f, 20.0f, 20.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[74/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp5);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Nodes()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp6);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Nodes()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp7);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[74/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp8);
    temp6->Value(::STRINGS[36/*"See Fuse Mo...*/]);
    ...
    temp7->Text(::STRINGS[37/*"Got it"*/]);
    temp7->Padding(::g::Uno::Float4__New2(10.0f, 10.0f, 10.0f, 10.0f));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp7, uDelegate::New(::TYPES[62/*Fuse.Gestures.ClickedHandler*/], (void*)ErrorToast__OnClicked_fn, this));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[63/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp10);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[63/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp11);
    temp10->Factor(0.8f);
    temp10->Easing(25);
    temp10->Duration(0.2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[63/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp13);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[63/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp14);
    temp13->Factor(0.8f);
    temp13->Easing(26);
    temp13->Duration(0.4);
    ...
    temp2->Layer(0);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Strokes()), ::TYPES[76/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]), temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[74/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp15);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[74/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp16);
    temp3->Width(2.0f);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), temp4);
}
...
// private void OnClicked(object sender, Uno.EventArgs args) [instance] :2264
...
void ErrorToast::SetFillColor(::g::Uno::Float4 value, uObject* origin)
{
    ...
    if (::g::Uno::Float4__op_Inequality(value, _field_FillColor))
    {
        ...
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[34/*"FillColor"*/]), origin);
    }
}
...
void ErrorToast::SetMessage(uString* value, uObject* origin)
{
    ...
    if (::g::Uno::String::op_Inequality(value, _field_Message))
    {
        ...
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[31/*"Message"*/]), origin);
    }
}
...
void ErrorToast::SetShowMonitorInfo(bool value, uObject* origin)
{
    ...
    if (value != _field_ShowMonitorInfo)
    {
        ...
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[32/*"ShowMonitor...*/]), origin);
    }
}
...
void ErrorToast::SetStrokeColor(::g::Uno::Float4 value, uObject* origin)
{
    ...
    if (::g::Uno::Float4__op_Inequality(value, _field_StrokeColor))
    {
        ...
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[35/*"StrokeColor"*/]), origin);
    }
}
...
// internal static class Exceptions :664
// {
static void Exceptions_build(uType* type)
{
    ::TYPES[39] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[78] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[79] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[80] = ::g::Uno::AggregateException_typeof();
    ::TYPES[0] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof());
}
...
// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) :666
void Exceptions__Send_fn(uObject* client, ::g::Uno::Collections::List* exceptions)
{
    Exceptions::Send(client, exceptions);
}

// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) :675
void Exceptions__Unpack_fn(::g::Uno::Exception* e, ::g::Uno::Collections::List** __retval)
{
    *__retval = Exceptions::Unpack(e);
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) [static] :666
...
// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) [static] :675
::g::Uno::Collections::List* Exceptions::Unpack(::g::Uno::Exception* e)
{
    ...
    ::g::Uno::Exception* ret2;
    ::g::Uno::Collections::List* exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[79/*Uno.Collections.List<Uno.Exception>*/]);

    if (uIs(e, ::TYPES[80/*Uno.AggregateException*/]))
    {
        ::g::Uno::AggregateException* aggregate = uCast< ::g::Uno::AggregateException*>(e, ::TYPES[80/*Uno.AggregateException*/]);
    ...
    else
    {
        ...
        if (uPtr(e)->InnerException() != NULL)
            ::g::Uno::Collections::List__Add_fn(uPtr(exceptions), uPtr(e)->InnerException());
    }
...
// internal sealed class FailedToConnect :727
// {
static void FailedToConnect_build(uType* type)
{
    ::STRINGS[38] = uString::Const("Failed to connect");
    ::STRINGS[39] = uString::Const("Please check that this device is connected to the same network as your computer.");
    ::STRINGS[21] = uString::Const("Change IP");
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[40] = uString::Const("Try again");
    ::TYPES[49] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    type->SetFields(5);
}
...
void FailedToConnect::ctor_2(::g::Uno::Exception* exception)
{
    ...
    ctor_1(::STRINGS[38/*"Failed to c...*/], ::STRINGS[39/*"Please chec...*/], uPtr(exception)->Message(), ::g::Outracks::Simulator::GoOffline::PrependOption(uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[49/*Outracks.Simulator.DialogButton[]*/], 2, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[21/*"Change IP"*/], ::g::Outracks::Simulator::ChangeIp::New1(::STRINGS[0/*""*/])), (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[40/*"Try again"*/], ::g::Outracks::Simulator::ConnectingToProxy::New1()))));
}

// public FailedToConnect New(Uno.Exception exception) [static] :729
...
{
    ctor_1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uPtr(endpoint)->ToString(), ::STRINGS[41/*": "*/]), uPtr(e)->Message()));
}
...
{
    ::STRINGS[42] = uString::Const("Failed to connect to proxy:\n"
        "");
    ::TYPES[81] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Uno::Exception_typeof());
    type->SetFields(3,
...
{
    ctor_1(::g::Uno::String::op_Addition2(::STRINGS[42/*"Failed to c...*/], ::g::Outracks::Simulator::AggregateConnectError::ToIndentedLines(innerExceptions)));
    InnerExceptions = ((::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[81/*Outracks.Simulator.List.ToImmutableList<Uno.Exception>*/], innerExceptions));
}
...
// public sealed class FailedToConnectToSimulator :939
// {
static void FailedToConnectToSimulator_build(uType* type)
{
    ::STRINGS[43] = uString::Const("Failed to connect to simulator host: ");
    ::TYPES[81] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Uno::Exception_typeof());
    type->SetFields(3,
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :943
void FailedToConnectToSimulator__ctor_3_fn(FailedToConnectToSimulator* __this, uObject* innerExceptions)
{
    __this->ctor_3(innerExceptions);
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :943
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [instance] :943
void FailedToConnectToSimulator::ctor_3(uObject* innerExceptions)
{
    ctor_1(::g::Uno::String::op_Addition2(::STRINGS[43/*"Failed to c...*/], ::g::Outracks::Simulator::AggregateConnectError::ToIndentedLines(innerExceptions)));
    InnerExceptions = ((::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[81/*Outracks.Simulator.List.ToImmutableList<Uno.Exception>*/], innerExceptions));
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [static] :943
...
// public sealed class FakeApp :1873
// {
static void FakeApp_build(uType* type)
{
    ::TYPES[82] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[14] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[83] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[84] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[58] = ::g::Uno::Int_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
...
// protected override sealed void OnRooted() :1901
...
// protected override sealed void OnUnrooted() :1907
...
void FakeApp::ctor_7(::g::Fuse::App* app)
{
    ...
    _flashes = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[82/*Outracks.Simulator.ConcurrentQueue<string>*/]));
    ctor_6();
    _app = app;
...
// private void AddNewFlashes() [instance] :1946
...
// public new float4 get_Background() [instance] :1960
...
// public new void set_Background(float4 value) [instance] :1961
...
// public new Uno.Collections.IList<Fuse.Node> get_Children() [instance] :1966
...
// public float4 get_ClearColor() [instance] :1994
...
// public void set_ClearColor(float4 value) [instance] :1995
...
// public float get_ClearDepth() [instance] :2000
...
// public void set_ClearDepth(float value) [instance] :2001
void FakeApp::ClearDepth(float value)
{
}

// public void Flash(string message) [instance] :1920
...
// private bool get_HasFlash() [instance] :1934
...
// private void OnUpdate() [instance] :1913
...
// public Fuse.Node get_Overlay() [instance] :1978
::g::Fuse::Node* FakeApp::Overlay()
{
    uStackFrame __("Outracks.Simulator.FakeApp", "get_Overlay()");
    ::g::Fuse::Node* ret3;
    return (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[83/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], uPtr(_overlayPlaceholde)->Children(), &ret3), ret3);
}

// public void set_Overlay(Fuse.Node value) [instance] :1979
...
// private bool get_OverlayVisible() [instance] :1885
...
// private void set_OverlayVisible(bool value) [instance] :1886
...
// private void RemoveExpiredFlashes() [instance] :1937
...
// public new Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :1973
...
// private void UpdateFlashes() [instance] :1925
...
// public FakeApp New(Fuse.App app) [static] :1893
...
// internal sealed class Faulted :699
// {
static void Faulted_build(uType* type)
{
    ::STRINGS[44] = uString::Const("Oops! Something went wrong here.");
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :701
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :701
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [instance] :701
void Faulted::ctor_2(bool isOnline, ::g::Uno::Exception* exception, uArray* buttons)
{
    ...
    ctor_1(::STRINGS[44/*"Oops! Somet...*/], ::g::Uno::String::op_Addition2(uPtr(exception)->Message(), isOnline ? ::STRINGS[45/*"\n\nPlease ...*/] : ::STRINGS[0/*""*/]), ::STRINGS[0/*""*/], buttons);
}

// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [static] :701
...
// internal sealed class Flasher :2037
// {
static void Flasher_build(uType* type)
{
    ::STRINGS[46] = uString::Const("#222");
    ::TYPES[85] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[86] = ::g::Fuse::Drawing::Brush_typeof();
    ::TYPES[14] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
...
// protected override sealed void OnUnrooted() :2067
...
// private void OnUpdate() :2073
void Flasher__OnUpdate_fn(Flasher* __this)
{
    __this->OnUpdate();
}

// public Flasher(string text) [instance] :2041
void Flasher::ctor_7(uString* text)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[85/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind2 = ::g::Uno::Color::FromHex(::STRINGS[46/*"#222"*/]), ::g::Uno::Float3__New2(ind2.X, ind2.Y, ind2.Z)), 0.9f), 0.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[85/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind3 = ::g::Uno::Color::FromHex(::STRINGS[46/*"#222"*/]), ::g::Uno::Float3__New2(ind3.X, ind3.Y, ind3.Z)), 0.9f), 1.0f));
...
// private double get_AnimationParameter() [instance] :2085
...
// public bool IsExpired() [instance] :2078
...
// private void OnUpdate() [instance] :2073
...
// public Flasher New(string text) [static] :2041
...
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[47] = uString::Const("Call Tom Curise");
    ::TYPES[18] = ::g::Uno::Exception_typeof();
    ::TYPES[50] = ::g::Uno::Net::EndPoint_typeof();
    ::TYPES[87] = ::g::Uno::IO::Stream_typeof();
    ::TYPES[26] = ::g::Uno::Net::IPEndPoint_typeof()->Array();
    ::TYPES[23] = ::g::Uno::IDisposable_typeof();
    type->SetFields(0,
...
uArray* GetSimulatorEndpoint::Execute()
{
    ...
    try
    {
        ...
        U_THROW(::g::Uno::Exception::New2(::STRINGS[47/*"Call Tom Cu...*/]));
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
// internal static class GoOffline :767
// {
static void GoOffline_build(uType* type)
{
    ::STRINGS[48] = uString::Const("Go offline");
    ::TYPES[25] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof());
    ...
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[39] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[91] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->Array();
    ::TYPES[92] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof();
    ::TYPES[93] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[94] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
}
...
// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) :769
void GoOffline__PrependOption_fn(uArray* otherButtons, uArray** __retval)
{
    *__retval = GoOffline::PrependOption(otherButtons);
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) [static] :769
uArray* GoOffline::PrependOption(uArray* otherButtons)
{
    ...
    return oldReify.HasValue(::TYPES[25/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]) ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[88/*Uno.Collections.EnumerableExtensions.ToArray<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[89/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::AsEnumerable(::TYPES[90/*Uno.Collections.EnumerableExtensions.AsEnumerable<Outracks.Simulator.DialogButton>*/], uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[49/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[48/*"Go offline"*/], ::g::Outracks::Simulator::Idle::New1((uObject*)::g::Outracks::Simulator::OfflineSimulatorClient::New1(uArray::Init< ::g::Outracks::Simulator::Protocol::MessageToClient*>(::TYPES[91/*Outracks.Simulator.Protocol.MessageToClient[]*/], 1, (::g::Outracks::Simulator::Protocol::Reify*)oldReify.Value(::TYPES[25/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]))))))), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[94/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.DialogButton>*/], otherButtons)))) : otherButtons;
}
// }
...
// internal sealed class Idle :487
// {
static void Idle_build(uType* type)
{
    ::STRINGS[49] = uString::Const("Loading");
    ::STRINGS[50] = uString::Const("Starting project...");
    ::STRINGS[40] = uString::Const("Try again");
    ::TYPES[95] = ::g::Uno::Diagnostics::LogHandler_typeof();
    ::TYPES[39] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[78] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[49] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
...
// public Idle(Outracks.Simulator.ISimulatorClient client) :489
void Idle__ctor_2_fn(Idle* __this, uObject* client)
{
    __this->ctor_2(client);
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) :489
void Idle__New1_fn(uObject* client, Idle** __retval)
{
    *__retval = Idle::New1(client);
}

// public override sealed Outracks.Simulator.State OnEnterState() :493
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::SetLogHandler(uDelegate::New(::TYPES[95/*Uno.Diagnostics.LogHandler*/], (void*)Idle__SendDebugLog_fn, __this));
    ...
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[49/*"Loading"*/], ::STRINGS[50/*"Starting pr...*/]);
    return *__retval = __this, void();
}

// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :506
...
// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) :501
void Idle__SendDebugLog_fn(Idle* __this, uString* text, int* type)
{
    __this->SendDebugLog(text, *type);
}

// public Idle(Outracks.Simulator.ISimulatorClient client) [instance] :489
...
// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) [instance] :501
...
// public Idle New(Outracks.Simulator.ISimulatorClient client) [static] :489
...
{
    ::TYPES[38] = uObject_typeof()->Array();
    ::TYPES[96] = ::g::Uno::Array_typeof();
    ::TYPES[97] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[98] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    ::TYPES[99] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[16] = uObject_typeof();
    type->SetPrecalc(
        type->T(0)->Array(),
...
static void IndentString_build(uType* type)
{
    ...
    ::TYPES[100] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[47] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[48] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[101] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[102] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    type->Reflection.SetFunctions(1,
...
uString* IndentString::Indent(uString* str)
{
    ...
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[100/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[48/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int>(::TYPES[101/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[102/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[2/*"\n"*/]);
}
...
uString* IndentString::PrefixWithTab(uString* s)
{
    ...
    return ::g::Uno::String::op_Addition2(::STRINGS[51/*"\t"*/], s);
}
// }
...
// public abstract interface ISimulatorClient :895
// {
...
{
    ::TYPES[103] = ::g::Outracks::Simulator::ImmutableList_typeof();
    ::TYPES[38] = uObject_typeof()->Array();
    ::TYPES[99] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
...
{
    uType* __types[] = {
        ::TYPES[103/*Outracks.Simulator.ImmutableList`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
::g::Outracks::Simulator::ImmutableList* List::ToImmutableList(uType* __type, uObject* self)
{
    uType* __types[] = {
        ::TYPES[103/*Outracks.Simulator.ImmutableList`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[99/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(1, __type->U(0)),
    };
...
// internal sealed class LoadingScreen :1278
// {
...
// public generated LoadingScreen() :1278
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New() :1278
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) :1280
...
// public generated LoadingScreen() [instance] :1278
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static] :1278
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) [static] :1280
...
// internal sealed class ModalDialog :1309
// {
static void ModalDialog_build(uType* type)
{
    ::STRINGS[52] = uString::Const("1*,auto");
    ::STRINGS[53] = uString::Const("1*,1*,2*");
    ::TYPES[14] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    ::TYPES[105] = ::g::Uno::UX::FileSource_typeof();
    ::TYPES[106] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[107] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Controls::Control_typeof());
    ::TYPES[108] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[109] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
}
...
// public generated ModalDialog() :1309
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New() :1309
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1355
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1311
...
// public generated ModalDialog() [instance] :1309
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static] :1309
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1355
void ModalDialog::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons)
{
    ...
    uArray* buttonArray = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[107/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Controls.Control>*/], buttons);
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1311
void ModalDialog::ShowPrompt(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons)
{
    ...
    for (uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[108/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum6), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Controls::Control* btn = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum6), ::TYPES[109/*Uno.Collections.IEnumerator<Fuse.Controls.Control>*/]), &ret43), ret43);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stackPanel)->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), buttonPanel);
    ::g::Fuse::Controls::ClientPanel* root = ::g::Fuse::Controls::ClientPanel::New5();
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(root->Children()), ::TYPES[14/*Uno.Collections.ICollection<Fuse.Node>*/]), stackPanel);
    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
...
// public sealed class OfflineSimulatorClient :904
// {
static void OfflineSimulatorClient_build(uType* type)
{
    ::TYPES[110] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageFromClient_typeof());
    ::TYPES[111] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageToClient_typeof());
    type->SetInterfaces(
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :909
...
// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() :917
...
// public bool get_IsOnline() :932
void OfflineSimulatorClient__get_IsOnline_fn(OfflineSimulatorClient* __this, bool* __retval)
{
    *__retval = __this->IsOnline();
}

// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :909
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) :920
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [instance] :909
void OfflineSimulatorClient::ctor_(uArray* initialMessages)
{
    ...
    int index2;
    int length3;
    _messagesFromClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[110/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/]));
    _messagesToClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[111/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/]));
...
// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :917
...
// public bool get_IsOnline() [instance] :932
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :920
...
// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [static] :909
...
{
    ::TYPES[112] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[45] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[52] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[113] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[114] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[115] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[116] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[117] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[118] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Uno::Net::IPEndPoint_typeof()->Array());
    type->Reflection.SetFunctions(2,
...
::g::Outracks::Simulator::Task* ProxyClient::GetSimulatorEndpoint(uObject* proxyEndpoints, uString* project, uObject* defines)
{
    ...
    ::g::Uno::Collections::List* tasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[112/*Uno.Collections.List<Outracks.Simulator.Task<Uno.Net.IPEndPoint[]>>*/]);
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(proxyEndpoints), ::TYPES[45/*Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ...
        ::g::Uno::Collections::List__Add_fn(uPtr(tasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[113/*Outracks.Simulator.Tasks.Run<Uno.Net.IPEndPoint[]>*/], uDelegate::New(::TYPES[114/*Uno.Func<Uno.Net.IPEndPoint[]>*/], (void*)::g::Outracks::Simulator::GetSimulatorEndpoint__Execute_fn, ::g::Outracks::Simulator::GetSimulatorEndpoint::New1(endpoint, project, (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[115/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], defines)))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[116/*Outracks.Simulator.Tasks.WaitForFirstResult<Uno.Net.IPEndPoint[]>*/], (uObject*)tasks, uDelegate::New(::TYPES[118/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Uno.Net.IPEndPoint[]>*/], (void*)ProxyClient__OnNoResult_fn));
}
...
// internal sealed class Reifying :550
// {
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :554
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :554
...
// public override sealed Outracks.Simulator.State OnEnterState() :560
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :572
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [instance] :554
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [static] :554
...
// internal sealed class Running :578
// {
static void Running_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[54] = uString::Const("Restart");
    ::STRINGS[23] = uString::Const("N/A");
    ::STRINGS[55] = uString::Const("Density changed, reifying");
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[16] = uObject_typeof();
    ::TYPES[15] = ::g::Fuse::Node_typeof();
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[39] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[49] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[58] = ::g::Uno::Int_typeof();
    ::TYPES[119] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[67] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[78] = ::g::Outracks::Simulator::Protocol::MessageFromClient_typeof();
    ::TYPES[59] = ::g::Fuse::Preview::ISelection_typeof();
    type->SetFields(1,
...
// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :585
...
// private static string GetTag(Fuse.Node node) :652
void Running__GetTag_fn(::g::Fuse::Node* node, uString** __retval)
{
    *__retval = Running::GetTag(node);
}

// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :585
...
// public override sealed Outracks.Simulator.State OnEnterState() :595
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :619
void Running__OnFaulted_fn(Running* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(::g::Outracks::Simulator::ISimulatorClient::IsOnline(uInterface(uPtr(__this->Client), ::TYPES[39/*Outracks.Simulator.ISimulatorClient*/])), e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[49/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[54/*"Restart"*/], ::g::Outracks::Simulator::ConnectingToProxy::New1()))), void();
}

// public override sealed void OnLeaveState() :602
...
// public override sealed Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :630
void Running__OnPointerPressed_fn(Running* __this, ::g::Fuse::Input::PointerPressedArgs* args, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uString* selectedTag = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[119/*Uno.Collections.ICollection<Fuse.Visual>*/])) >= 1) ? (uString*)Running::GetTag((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[67/*Uno.Collections.IList<Fuse.Visual>*/]), uCRef<int>(0), &ret2), ret2)) : ::STRINGS[23/*"N/A"*/];
...
// public override sealed Outracks.Simulator.State OnUpdate() :607
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[55/*"Density cha...*/], 1, ::STRINGS[56/*"/usr/local/...*/], 612);
...
// private static float QueryDensity() :624
void Running__QueryDensity_fn(float* __retval)
{
    *__retval = Running::QueryDensity();
}

// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [instance] :585
...
// private static string GetTag(Fuse.Node node) [static] :652
...
// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [static] :585
...
// private static float QueryDensity() [static] :624
...
{
    Serialization::ReadString_ = uDelegate::New(::TYPES[120/*Uno.Func<Uno.IO.BinaryReader, string>*/], (void*)Serialization___ReadString_fn);
}

static void Serialization_build(uType* type)
{
    ::TYPES[120] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
// internal class ShowingModalDialog :1530
// {
static void ShowingModalDialog_build(uType* type)
{
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[121] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[122] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[123] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[124] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[62] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[125] = ::g::Outracks::Simulator::ForgetAction_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof());
    ::TYPES[12] = ::g::Fuse::Visual_typeof();
    ::TYPES[126] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[108] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    ::TYPES[127] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    type->SetFields(0,
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1539
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1539
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) :1572
...
// public override sealed Outracks.Simulator.State OnEnterState() :1551
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uDelegate* ret8;
    ::g::Uno::Collections::List* buttons = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[122/*Uno.Collections.List<Fuse.Controls.Control>*/]);
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* action = (::g::Outracks::Simulator::Closure__Apply_fn(::TYPES[123/*Outracks.Simulator.Closure.Apply<Outracks.Simulator.DialogButton>*/], uDelegate::New(::TYPES[124/*Uno.Action<Outracks.Simulator.DialogButton>*/], (void*)ShowingModalDialog__OnButtonClicked_fn, __this), button, &ret8), ret8);
        uDelegate* handler = uDelegate::New(::TYPES[62/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction__Execute_fn, (::g::Outracks::Simulator::ForgetAction*)::g::Outracks::Simulator::ForgetAction::New1(::TYPES[125/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :1585
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[56/*"/usr/local/...*/], 1587);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :1577
void ShowingModalDialog__OnUpdate_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().HasValue(::TYPES[127/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))
        return *__retval = uPtr(__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().Value(::TYPES[127/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))->Destination, void();

    return *__retval = __this, void();
}

// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [instance] :1539
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) [instance] :1572
void ShowingModalDialog::OnButtonClicked(::g::Outracks::Simulator::DialogButton* button)
{
    ...
    _clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >() = (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[121/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.DialogButton>*/], button, &ret7), ret7);
}

// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [static] :1539
...
// internal abstract class ShowingPrompt :1459
// {
static void ShowingPrompt_build(uType* type)
{
    ::STRINGS[57] = uString::Const("Ok");
    ::STRINGS[58] = uString::Const("Cancel");
    ::STRINGS[59] = uString::Const("# ");
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[12] = ::g::Fuse::Visual_typeof();
    ::TYPES[62] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[128] = ::g::Fuse::Controls::TextInput_typeof();
    ::TYPES[126] = ::g::Fuse::Controls::Control_typeof();
    ::TYPES[108] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[129] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[130] = ::g::Fuse::Controls::Control_typeof()->Array();
    ::TYPES[3] = ::g::Outracks::Simulator::State_typeof();
    type->SetFields(0,
...
// protected ShowingPrompt(string header, string body) :1468
void ShowingPrompt__ctor_1_fn(ShowingPrompt* __this, uString* header, uString* body)
{
    __this->ctor_1(header, body);
}

// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) :1509
...
// public override sealed Outracks.Simulator.State OnEnterState() :1476
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ;
    uPtr(collection1)->Text(::STRINGS[57/*"Ok"*/]);
    ::STRINGS[57/*"Ok"*/];
    ...
    ;
    uPtr(collection2)->Text(::STRINGS[58/*"Cancel"*/]);
    ::STRINGS[58/*"Cancel"*/];
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[59/*"# "*/], __this->_header), 1, ::STRINGS[56/*"/usr/local/...*/], 1497);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[56/*"/usr/local/...*/], 1498);
    ::g::Outracks::Simulator::ModalDialog::ShowPrompt(::g::Outracks::Simulator::Context::App(), __this->_header, __this->_body, __this->_input, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[129/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.Control>*/], uArray::Init< ::g::Fuse::Controls::Control*>(::TYPES[130/*Fuse.Controls.Control[]*/], 2, cancel, ok))));
    return *__retval = __this, void();
}

// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) :1504
...
// public override sealed Outracks.Simulator.State OnUpdate() :1518
...
// protected ShowingPrompt(string header, string body) [instance] :1468
...
// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1509
...
// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1504
...
// public sealed class SimulatorClient :993
// {
...
// public void Dispose() [instance] :1078
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[56/*"/usr/local/...*/], 1093);
    }
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :1006
...
// public bool get_IsOnline() [instance] :1099
...
// private void ReadLoop() [instance] :1040
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :1009
...
// private void WriteLoop() [instance] :1058
...
// public SimulatorClient New(Uno.Net.Sockets.Socket socket) [static] :1014
...
// internal abstract class State :272
// {
...
// protected generated State() :272
void State__ctor__fn(State* __this)
{
    __this->ctor_();
}

// public virtual Outracks.Simulator.State OnEnterState() :274
...
// public virtual void OnLeaveState() :279
void State__OnLeaveState_fn(State* __this)
{
}

// public virtual Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :288
...
// public virtual Outracks.Simulator.State OnUpdate() :283
...
// protected generated State() [instance] :272
void State::ctor_()
{
}
// }
...
static void StringSplitting_build(uType* type)
{
    ::TYPES[47] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[131] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[97] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[104] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->Reflection.SetFunctions(8,
...
uString* StringSplitting::Join(uObject* si, uString* separator)
{
    ...
    {
        uString* part = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[131/*Uno.Collections.IEnumerator<string>*/]), &ret2), ret2);
...
uString* StringSplitting::JoinToString(uType* __type, uObject* objects, uString* separator)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[97/*Uno.Collections.IEnumerable`1*/]->MakeType(__type->U(0)),
        ::TYPES[104/*Uno.Collections.IEnumerator`1*/]->MakeType(__type->U(0)),
    };
...
{
    ::TYPES[132] = ::g::Outracks::Simulator::TaskThread_typeof();
    ::TYPES[133] = ::g::Uno::Func_typeof();
    ::TYPES[134] = ::g::Outracks::Simulator::WaitForFirstResult_typeof();
    type->Reflection.SetFunctions(2,
...
{
    uType* __types[] = {
        ::TYPES[132/*Outracks.Simulator.TaskThread`1*/]->MakeType(__type->U(0)),
        __type->U(0),
    };
...
::g::Outracks::Simulator::Task* Tasks::WaitForFirstResult(uType* __type, uObject* tasks, uDelegate* onNoResult)
{
    uType* __types[] = {
        ...
        __type->U(0),
        ::TYPES[133/*Uno.Func`1*/]->MakeType(__type->U(0)),
        ::TYPES[134/*Outracks.Simulator.WaitForFirstResult`1*/]->MakeType(__type->U(0)),
    };
...
{
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[135] = ::g::Outracks::Simulator::Task_typeof();
    ::TYPES[18] = ::g::Uno::Exception_typeof();
    type->SetPrecalc(
...
// internal sealed class Uninitialized :320
// {
...
// public generated Uninitialized() :320
void Uninitialized__ctor_1_fn(Uninitialized* __this)
{
    __this->ctor_1();
}

// public generated Uninitialized New() :320
void Uninitialized__New1_fn(Uninitialized** __retval)
{
    *__retval = Uninitialized::New1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :330
void Uninitialized__OnException_fn(Uninitialized* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(false, e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[49/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[40/*"Try again"*/], __this))), void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :322
...
// public generated Uninitialized() [instance] :320
...
// public generated Uninitialized New() [static] :320
...
// internal sealed class UserAppState :803
// {
static void UserAppState_build(uType* type)
{
    ::TYPES[136] = UserAppState_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[137] = UserAppState_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[138] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[84] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[139] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[140] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[141] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[16] = uObject_typeof();
    ::TYPES[142] = ::g::Uno::Collections::IList_typeof();
    ::TYPES[143] = ::g::Uno::Collections::IListExtensions_typeof();
    ::TYPES[97] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[98] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->SetFields(0,
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :817
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) :844
void UserAppState__ApplyTo_fn(UserAppState* __this, ::g::Outracks::Simulator::FakeApp* app)
{
    __this->ApplyTo(app);
}

// public static generated Outracks.Simulator.UserAppState get_Default() :832
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) :832
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :817
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) :834
void UserAppState__Save_fn(::g::Outracks::Simulator::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) :865
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) :853
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) :859
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [instance] :817
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) [instance] :844
void UserAppState::ApplyTo(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    UserAppState::SetIfNotEqual(::TYPES[136/*Outracks.Simulator.UserAppState.SetIfNotEqual<Fuse.Node>*/], uPtr(app)->Children1(), Children);
    UserAppState::SetIfNotEqual(::TYPES[137/*Outracks.Simulator.UserAppState.SetIfNotEqual<Uno.UX.Resource>*/], app->Resources1(), Resources);
...
// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [static] :817
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) [static] :834
UserAppState* UserAppState::Save(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[138/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], uPtr(app)->Children1()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[139/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->ClearColor(), uPtr(app)->ClearDepth());
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static] :865
bool UserAppState::SequenceEquals(uType* __type, uObject* left, uArray* right)
{
    uType* __types[] = {
        __type->U(0),
        ::TYPES[141/*Uno.Collections.ICollection`1*/]->MakeType(__type->U(0)),
        ::TYPES[142/*Uno.Collections.IList`1*/]->MakeType(__type->U(0)),
    };
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static] :853
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static] :859
void UserAppState::SetSequence(uType* __type, uObject* list, uArray* elements)
{
    uType* __types[] = {
        ::TYPES[141/*Uno.Collections.ICollection`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[143/*Uno.Collections.IListExtensions*/]->MakeMethod(1, __type->U(0)),
        ::TYPES[97/*Uno.Collections.IEnumerable`1*/]->MakeType(__type->U(0)),
        ::TYPES[98/*Uno.Runtime.Implementation.Internal.ArrayEnumerable`1*/]->MakeType(__type->U(0)),
    };
...
// public static generated Outracks.Simulator.UserAppState get_Default() [static] :832
...
// public static generated void set_Default(Outracks.Simulator.UserAppState value) [static] :832
