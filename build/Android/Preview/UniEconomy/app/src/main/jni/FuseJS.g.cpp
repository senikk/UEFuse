...
// /usr/local/share/uno/Packages/FuseJS/0.31.5/$.uno
// -------------------------------------------------

// public sealed class Base64 :331
// {
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :366
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :398
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :350
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :382
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :366
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :398
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :350
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :382
...
// public sealed class Bundle :433
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :503
...
// private static string Read(string filename) [static] :513
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :477
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :530
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :445
...
// public Environment() :303
void Environment__ctor_2_fn(Environment* __this)
{
    __this->ctor_2();
}

// public Environment New() :303
...
// public Environment() [instance] :303
...
// public Environment New() [static] :303
...
// private sealed class FileReaderImpl.FileReadCommand :566
// {
...
// public string ReadAsDataURL() :577
...
// public FileReadCommand(string path) [instance] :569
...
// public string ReadAsDataURL() [instance] :577
...
// public string ReadAsText() [instance] :573
...
// public FileReadCommand New(string path) [static] :569
...
// public sealed class FileReaderImpl :564
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :601
...
// public FileReaderImpl() [instance] :587
...
// public FileReaderImpl New() [static] :587
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :595
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :601
...
// public sealed class Lifecycle :135
// {
...
// private static int Converter(Fuse.Scripting.Context context, int state) :259
...
// private static int GetCurrentState() :173
...
// private static void OnEnteringBackground(Fuse.Platform.ApplicationState newState) :252
void Lifecycle__OnEnteringBackground_fn(int* newState)
{
    Lifecycle::OnEnteringBackground(*newState);
}

// private static void OnEnteringForeground(Fuse.Platform.ApplicationState newState) :198
void Lifecycle__OnEnteringForeground_fn(int* newState)
{
    Lifecycle::OnEnteringForeground(*newState);
}

// private static void OnEnteringInteractive(Fuse.Platform.ApplicationState newState) :216
void Lifecycle__OnEnteringInteractive_fn(int* newState)
{
    Lifecycle::OnEnteringInteractive(*newState);
}

// private static void OnExitedInteractive(Fuse.Platform.ApplicationState newState) :234
void Lifecycle__OnExitedInteractive_fn(int* newState)
{
    Lifecycle::OnExitedInteractive(*newState);
}

// private static void OnJsInitialized(object sender, Uno.EventArgs args) :178
...
// private static int Converter(Fuse.Scripting.Context context, int state) [static] :259
...
// private static int GetCurrentState() [static] :173
...
// private static void OnEnteringBackground(Fuse.Platform.ApplicationState newState) [static] :252
...
// private static void OnEnteringForeground(Fuse.Platform.ApplicationState newState) [static] :198
...
// private static void OnEnteringInteractive(Fuse.Platform.ApplicationState newState) [static] :216
...
// private static void OnExitedInteractive(Fuse.Platform.ApplicationState newState) [static] :234
...
// private static void OnJsInitialized(object sender, Uno.EventArgs args) [static] :178
...
// internal sealed class RaiseEvent :618
// {
static void RaiseEvent_build(uType* type)
{
    ::STRINGS[37] = uString::Const("Cannot find message with name: ");
    ::STRINGS[38] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.31.5/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[37/*"Cannot find...*/], Name), this, ::STRINGS[38/*"/usr/local/...*/], 630, ::STRINGS[39/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :618
...
// private sealed class Bundle.ReadClosure :535
// {
...
// public ReadClosure(string filename) [instance] :539
...
// public string Invoke() [instance] :544
...
// public ReadClosure New(string filename) [static] :539
...
// public sealed class UserEvents :640
// {
...
// public UserEvents() :643
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :643
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :656
...
// public UserEvents() [instance] :643
...
// public UserEvents New() [static] :643
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :656
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[42/*"The FuseJS/...*/], context, ::STRINGS[38/*"/usr/local/...*/], 661, ::STRINGS[39/*"Raise"*/]);
