...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.0.0.118"), 12124)}, "/Users/terjepedersen/Prosjekt/Fuse/UniEconomy/UniEconomy.unoproj", GetBundle, new string[] { ""})
{
...
{
return Uno.IO.Bundle.Get("UniEconomy");
}
}
}
