...
public class AppRoot
{
    ...
    public static void ClearRootView169(final Object handle)
    {
        ((android.widget.RelativeLayout)handle).removeAllViews();
    }
    
    public static Object CreateRootView170()
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(Fuse.Preview.UniEconomy.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__171(motionEvent,UnoHelper.GetUnoObjectRef(motionEvent));
    ...
    public static void SetChildSize1172(final Object handle,final int w,final int h)
    {
    ...
    public static void SetRootView173(final Object handle,final Object rootHandle)
    {
