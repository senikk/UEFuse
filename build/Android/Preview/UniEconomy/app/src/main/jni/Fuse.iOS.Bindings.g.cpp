...
// /usr/local/share/uno/Packages/Fuse.iOS/0.31.5/$.uno
// ---------------------------------------------------
...
void Blitter::init_DrawCalls()
{
    ...
    _draw_83b8f5a6 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseiOS_bundle::Blitter8e9d1e2b());
}
