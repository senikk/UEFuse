...
public class TextEditRenderer
{
    ...
    public static void CopyState101(final Object container,final Object sourceHandle,final Object targetHandle)
    {
        ...
        target.setText(source.getText().toString());
    ...
    public static Object CreateContainer102()
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(Fuse.Preview.UniEconomy.GetRootActivity());
    ...
    public static Object CreateTextEdit103()
    {
        android.widget.TextView tv = new android.widget.TextView(Fuse.Preview.UniEconomy.GetRootActivity());
